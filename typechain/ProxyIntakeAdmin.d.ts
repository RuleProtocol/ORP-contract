...
interface ProxyIntakeAdminInterface extends ethers.utils.Interface {
  functions: {
    ...
    "upgradeToAndCall(address,address,bytes,bool)": FunctionFragment;
  };
...
export class ProxyIntakeAdmin extends BaseContract {
  ...
  interface: ProxyIntakeAdminInterface;
